...
const COHORTS = [
  ...
  { name: 'Cohort · Gift Purchasers', description: 'Users who said they are buying a gift', filters: { properties: { type: 'AND', values: [{ key: 'experience_quiz_completed', type: 'behavioral', value: 'performed_event', negation: false, event_type: 'events', event_properties: [{ key: 'purpose', value: 'gift', operator: 'exact', type: 'event' }] }] } } },
  { name: 'Cohort · Returning Users', description: 'Users who are identified as returning visitors', filters: { properties: { type: 'AND', values: [{ key: 'session_context', type: 'behavioral', value: 'performed_event', negation: false, event_type: 'events', event_properties: [{ key: 'is_returning_user', value: 'true', operator: 'exact', type: 'event' }] }] } } },
  ...
  { name: 'Cohort · Lamp Owners', description: 'Users who said Yes I own a lamp in the quiz', filters: { properties: { type: 'AND', values: [{ key: 'experience_quiz_completed', type: 'behavioral', value: 'performed_event', negation: false, event_type: 'events', event_properties: [{ key: 'owns_lamp', value: 'true', operator: 'exact', type: 'event' }] }] } } },
