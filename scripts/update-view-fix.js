...
unified_orders AS (
  ...
  -- Catch cases like 1188A vs #1188.
  -- For non-numeric names (like manual WH orders), we use the ID to prevent over-deduplication.
...
LEFT JOIN collector_profiles cp ON cp.user_id = u.id;
  ...
  else console.log('✅ Fixed view logic to prevent over-deduplication.');
}
