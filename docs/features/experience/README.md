...
- Version: 1.14.7
- **+ with title**: Picker and configurator strip show the add **+** as the leading icon inside the top title chip when the artwork is not selected / not in cart (same glass treatment as the title text).
