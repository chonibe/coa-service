...
- Version: 1.15.15
- **Reviews + welcome incentive (home)**: Live Yotpo store review summary powers hero/testimonials (“5.0 from N reviews”) via [`yotpo-store-reviews`](../../../lib/shop/yotpo-store-reviews.ts). First-visit welcome strip + Final CTA reveal use [`welcome-incentive`](../../../lib/shop/welcome-incentive.ts) / [`WelcomeIncentiveStrip`](../../../components/shop/WelcomeIncentiveStrip.tsx) (Stripe Promotion Code; see `.env.example`).
