...
- Idle yaw sway (~±15°) runs whenever the preview uses `animate` with default `idleSpinEnabled` (including with artworks on the lamp): [`SplineFullScreen`](../../../app/(store)/shop/experience/components/SplineFullScreen.tsx), [`CarouselStripLampSpline`](../../../app/(store)/shop/experience/components/CarouselStripLampSpline.tsx), and [`Configurator`](../../../app/(store)/shop/experience-v2/components/Configurator.tsx) / [`Spline3DPreview`](../../../app/template-preview/components/spline-3d-preview.tsx). Set `idleSpinEnabled={false}` only if a caller needs a fully static model.
