...
- Updated: 2026-03-27 — **Picker Street ladder UI** in [`ArtworkPickerSheet`](../../../app/(store)/shop/experience/components/ArtworkPickerSheet.tsx): **one list price** in the card footer (no overlay duplicate); stage label, [`subcopy` from `getStreetPricingStageDisplay`](../../../lib/shop/street-collector-pricing-stages.ts), and **next price bump** line from [`getStreetNextPriceBump`](../../../lib/shop/street-collector-pricing-stages.ts) via [`GET /api/shop/edition-states`](../../../app/api/shop/edition-states/route.ts) `nextBump`. Early-access strikethrough uses ladder reference. [`StreetPricingChip`](../../../app/(store)/shop/experience-v2/components/StreetPricingChip.tsx) remains for other compact overlays.
