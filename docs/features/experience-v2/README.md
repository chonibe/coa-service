...
**Implementation:** [`ArtworkDetail.tsx`](../../../app/(store)/shop/experience-v2/components/ArtworkDetail.tsx) · [`EditionWatchWithNarrative.tsx`](../../../app/(store)/shop/experience-v2/components/EditionWatchWithNarrative.tsx) · [`EditionBadge.tsx`](../../../app/(store)/shop/experience-v2/components/EditionBadge.tsx) (picker/strip/chip contexts) · [`edition-stages.ts`](../../../lib/shop/edition-stages.ts)
...
- **UI**: [`FilterPanel`](../../../app/(store)/shop/experience-v2/components/FilterPanel.tsx) optional CTA — primary **“Get [vendor] bundle — $159”** and strikethrough **regular** subtotal for the same trio (computed). [`ArtworkCarouselBar`](../../../app/(store)/shop/experience/components/ArtworkCarouselBar.tsx) shows a **single centered card** (lamp + two prints + pricing) when the collection is empty and the offer applies; [`ExperienceCheckoutStickyBar`](../../../app/(store)/shop/experience-v2/components/ExperienceCheckoutStickyBar.tsx) shows **Featured artist bundle · {vendor}** when the bundle is **active** in cart. Onboarding [`Configurator`](../../../app/(store)/shop/experience-v2/components/Configurator.tsx) receives the same offer via banner + filters.
