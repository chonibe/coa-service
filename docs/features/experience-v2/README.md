...
- Updated: 2026-03-28 — [`ExperienceCheckoutStickyBar`](../../../app/(store)/shop/experience-v2/components/ExperienceCheckoutStickyBar.tsx): below Tailwind **`md`**, checkout row shows **lamp thumbnail** (numeric badge when `lampQuantity` > 1) **+ “N added”** instead of artwork thumbs; **`md` and up**, full lamp + artwork strip unchanged.
