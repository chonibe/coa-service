...
- Updated: 2026-03-28 — **+** at the **end** of the **top title chip** on picker cards, strip cards when not in cart, and [`ArtworkCarouselBar`](../../../app/(store)/shop/experience/components/ArtworkCarouselBar.tsx) spotlight placeholders — no separate corner **+** on those surfaces.
