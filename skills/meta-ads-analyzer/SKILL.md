...
metadata:
  version: 1.0.0
  source: https://github.com/mathiaschu/meta-ads-analyzer (MIT)
---

# Meta Ads Analysis & Diagnosis Skill

## Cursor / MCP integration (this repo)

Live data comes from MCP servers configured in [`.cursor/mcp.json`](../../.cursor/mcp.json):

| Server | Endpoint | Use when |
|--------|----------|----------|
| `meta-ads` | `https://mcp.facebook.com/ads` | Official Meta MCP (OAuth, 29 tools) |
| `meta-ads-pipeboard` | `https://meta-ads.mcp.pipeboard.co/` | Pipeboard harness (42 tools, 1000+★) |

**Before analyzing:** confirm MCP is connected (Cursor Settings → MCP → complete OAuth). Prefer **read-only** scope until the operator approves writes.

**Companion skills:** [`meta-ads-run`](../meta-ads-run/SKILL.md) (launch workflow), [`ad-creative`](../ad-creative/SKILL.md) (copy), product context at [`.agents/product-marketing-context.md`](../../.agents/product-marketing-context.md).

**Harness reference:** [pipeboard-co/meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp) · [mathiaschu/meta-ads-analyzer](https://github.com/mathiaschu/meta-ads-analyzer)
