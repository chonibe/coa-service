...
// ============================================================================
// Collector Notifications Sub-tab — Phase 1.5
//
// API: /api/collector/notifications, /api/collector/notifications/mark-all-read
// Render: Notification cards with type icon, message, timestamp, unread dot
// Old source: app/collector/notifications/page.tsx
// ============================================================================
...
export default function CollectorNotificationsPage() {
  ...
  const fetchNotifications = useCallback(async () => {
    try {
      const res = await fetch('/api/collector/notifications', { credentials: 'include' })
              ...
              const inner = (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {notification.body && (
                      <p className="text-xs text-gray-500 font-body line-clamp-2 mt-0.5">
                        {notification.body}
                      </p>
                    )}
