...
export default function CustomerPreviewPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Customer Preview</h1>
        <p className="text-muted-foreground mb-6">
          View and test the customer experience for any customer in the system
        </p>
        ...
        {!selectedCustomerId ? (
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-center text-muted-foreground">No orders found for this customer</p>
            </CardContent>
          </Card>
        ) : (
