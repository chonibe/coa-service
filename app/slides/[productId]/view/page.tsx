...
/**
 * Vendor Preview - Shows slides exactly as collectors will see them
 * 
 * Full-screen Reels/Stories style preview
 */
export default function VendorSlidesPreview() {
  ...
  return (
    <div className="fixed inset-0 bg-black">
      ...
      {/* Preview Badge */}
      <div className="absolute top-16 left-4 bg-blue-500/80 backdrop-blur-sm px-3 py-1 rounded-full z-40">
