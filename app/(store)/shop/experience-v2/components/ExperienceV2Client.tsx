...
export function ExperienceV2Client({
  ...
  /** Featured bundle strip: lamp first, bundle pair, then every spotlight print (deduped; horizontal scroll). */
  ...
  const handleToggleSelect = useCallback(
    ...
    [getSideToShowForProduct, bumpReelAlign]
  )
  ...
  const handleFeaturedBundleThumbAddArtwork = useCallback(
    ...
    [getSideToShowForProduct, handleSpotlightSelect, triggerPriceBump, bumpReelAlign]
  )
  ...
  }, [carouselArtworks, handleLampSelect, lamp, bumpReelAlign])
