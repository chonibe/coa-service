        ...
        <Container maxWidth="default">
          {seriesList.length === 0 ? (
            <div className="text-center py-16">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-experience-highlight/10 rounded-full mb-6">
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-muted">
        {series.thumbnail_url ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#f5f5f5] to-[#e5e5e5]">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="opacity-20 text-muted-foreground">
              <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
              <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
            </svg>
          </div>
      ...
      <div className="p-5">
        ...
        <h3 className="font-heading text-xl font-semibold text-foreground mb-2 group-hover:text-experience-highlight transition-colors">
          {series.name}
        </h3>
        ...
        {/* CTA */}
        <div className="flex items-center gap-1.5 text-sm font-medium text-experience-highlight group-hover:gap-2.5 transition-all">
          <span>
