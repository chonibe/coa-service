          ...
          >
            <>
              {showStripMiniLampSpline && onJumpToSpline ? (
                <div
                  data-carousel-item
                  className="flex shrink-0 snap-start snap-always flex-row items-center gap-2"
                >
                  ...
                  {stripMode === 'collection' && onOpenPicker ? (
                    <button
                      type="button"
                      onClick={(e) => {
                        e.stopPropagation()
                      ...
                      className={cn(
                        glassAddWithJourney,
                        'h-[5.72rem] w-11 shrink-0 sm:h-[6.43rem] sm:w-12'
                      )}
