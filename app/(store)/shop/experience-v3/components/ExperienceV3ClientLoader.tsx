...
import { ShopDiscountFlagsProvider } from '../../experience-v2/components/ShopDiscountFlagsContext'
...
export function ExperienceV3ClientLoader({
  shopDiscountSettings,
  ...rest
}: ExperienceV3ClientLoaderProps) {
  return (
