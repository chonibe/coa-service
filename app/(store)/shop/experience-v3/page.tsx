...
import { ExperienceV3ClientLoader } from './components/ExperienceV3ClientLoader'
...
export async function generateMetadata({
  ...
  return buildShopExperienceMetadata(searchParams, '/shop/experience-v3')
}
...
type ExperienceV3PageProps = {
  searchParams: Promise<{ artist?: string; vendor?: string }>
}

export default async function ExperienceV3Page({ searchParams }: ExperienceV3PageProps) {
