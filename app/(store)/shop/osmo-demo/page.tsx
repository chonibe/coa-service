      ...
      <SectionWrapper spacing="lg" background="default">
        <Container maxWidth="default" paddingX="gutter">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-semibold text-foreground tracking-[-0.02em] mb-6">
        ...
        <SectionWrapper spacing="lg" background="subtle">
          <Container maxWidth="default" paddingX="gutter">
            <div className="text-center mb-12">
              <h2 className="font-heading text-4xl sm:text-5xl font-semibold text-foreground tracking-[-0.02em] mb-4">
                Flick Cards Gallery
              </h2>
