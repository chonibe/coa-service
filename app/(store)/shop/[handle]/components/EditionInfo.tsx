...
export function EditionInfo({ 
  ...
  return (
    <div className={cn('space-y-3', className)}>
      {/* Edition Badge */}
      <div className="inline-flex items-center gap-2 px-3 py-2 bg-muted rounded-lg border border-border text-foreground">
        <svg
          width="18"
          height="18"
          viewBox="0 0 24 24"
          ...
          <div className="relative h-2 bg-muted rounded-full overflow-hidden">
            <div
              className={cn(
                ...
                !isLowStock && 'bg-gradient-to-r from-experience-highlight to-experience-highlight-soft'
              )}
