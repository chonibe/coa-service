...
export function FixedCTAButton({ text, href, logoUrl = DEFAULT_LOGO_URL }: FixedCTAButtonProps) {
  ...
  if (renderDesktopBar) {
    return (
      <div
        className={cn(
          'fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-3 sm:px-4 py-1.5 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md border-b border-neutral-200/60 dark:border-white/10 transition-transform duration-300 ease-out',
