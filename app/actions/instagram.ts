...
export async function fetchInstagramStories(artistId: string) {
  try {
    ...
    // Fetch stories from Instagram - this might return an empty array if there are no stories
    ...
    try {
      ...
      if (stories && stories.length > 0) {
        ...
        console.log("No Instagram stories found or stories API not available for this account")
      }
    ...
    console.error("Error in fetchInstagramStories:", error)
