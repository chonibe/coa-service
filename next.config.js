...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspDirectives = [
      ...
      "frame-src 'self' https://*.supabase.co https://open.spotify.com https://*.spotify.com https://www.youtube.com https://player.vimeo.com https://www.googletagmanager.com https://my.spline.design https://*.spline.design https://embed.tawk.to https://*.tawk.to https://js.stripe.com https://*.stripe.com https://hooks.stripe.com https://us.posthog.com https://eu.posthog.com https://*.posthog.com https://www.instagram.com", // + Instagram embeds (artist profile process / showcase)
