-- Migration: Fix Collector View Fallback Logic
-- Ensures display_name and display_phone correctly fallback to email/null when subqueries return empty strings.
