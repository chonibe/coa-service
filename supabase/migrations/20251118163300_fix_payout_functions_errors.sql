-- Fix SQL errors in payout functions
-- 1. Change p.title to p.name (products table has 'name' column, not 'title')
-- 2. Fix ambiguous vendor_name reference in get_pending_vendor_payouts
