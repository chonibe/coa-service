-- Migration: Allow Street Collector items to have edition numbers
-- Updates the assign_edition_numbers RPC to include all active items regardless of vendor.
...
BEGIN
    ...
    -- We NO LONGER exclude Street Collector here
...
-- Update trigger function to remove Street Collector restriction
