-- Mark Migrations as Applied (Pre-application)
-- This runs BEFORE other migrations to prevent duplicate key errors
-- The CLI will skip migrations that are already in the history table

-- Mark all problematic migrations as already applied
-- This prevents the CLI from trying to insert them again
