...
-- Recreate the function with fully qualified parameter and quoted column
...
DECLARE
    ...
    v_product_id BIGINT;
BEGIN
    -- Convert the parameter to BIGINT
    v_product_id := assign_edition_numbers.p_product_id::BIGINT;
