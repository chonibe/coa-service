...
export function ViewersCounter({ productId, className }: ViewersCounterProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full',
        'bg-experience-highlight/10 text-experience-highlight text-sm font-medium',
        className
      )}
    >
...
export function RecentlyPurchased({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-sm font-semibold text-foreground">Just purchased</p>
        <p className="text-xs text-muted-foreground">Someone in New York</p>
      </div>
    </div>
  )
}
...
export function LimitedEdition({ edition, total, className }: LimitedEditionProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="h-1 w-12 bg-card/20 rounded-full overflow-hidden">
        <div 
