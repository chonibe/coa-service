...
/**
 * Shopify-style payment icons for footer bottom toolbar
 * Matches the exact SVGs from the live Shopify site
 */
const iconClass = 'w-[38px] h-6 shrink-0'
  ...
  return (
    <ul className={cn('flex flex-wrap items-center justify-center gap-2', className)}>
      <li className="contents">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pi-american_express" viewBox="0 0 38 24" width={38} height={24} className={iconClass}>
      ...
      <li className="contents">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x={0} y={0} width={38} height={24} viewBox="0 0 165.521 105.965" xmlSpace="preserve" aria-labelledby="pi-apple_pay" className={iconClass}>
      ...
      <li className="contents">
        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width={38} height={24} aria-labelledby="pi-diners_club" className={iconClass}>
      ...
      <li className="contents">
        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width={38} height={24} role="img" aria-labelledby="pi-discover" fill="none" className={iconClass}>
      ...
      <li className="contents">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width={38} height={24} aria-labelledby="pi-google_pay" className={iconClass}>
      ...
      <li className="contents">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" width={38} height={24} viewBox="0 0 38 24" aria-labelledby="pi-klarna" fill="none" className={iconClass}>
          <title id="pi-klarna">Klarna</title>
          <rect width={38} height={24} rx={2} fill="#FFA8CD" />
          <rect x=".5" y=".5" width={37} height={23} rx={1.5} stroke="#000" strokeOpacity={0.07} />
      ...
      <li className="contents">
        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width={38} height={24} role="img" aria-labelledby="pi-maestro" className={iconClass}>
      ...
      <li className="contents">
        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width={38} height={24} aria-labelledby="pi-master" className={iconClass}>
      ...
      <li className="contents">
        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width={38} height={24} role="img" aria-labelledby="pi-paypal" className={iconClass}>
      ...
      <li className="contents">
        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width={38} height={24} aria-labelledby="pi-shopify_pay" className={iconClass}>
      ...
      <li className="contents">
        <svg viewBox="-36 25 38 24" xmlns="http://www.w3.org/2000/svg" width={38} height={24} role="img" aria-labelledby="pi-unionpay" className={iconClass}>
      ...
      <li className="contents">
        <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width={38} height={24} aria-labelledby="pi-visa" className={iconClass}>
