...
const VENDOR_PAGES: SearchResult[] = [
  ...
  { title: "Profile", href: "/vendor/dashboard/profile", group: "Account", icon: <User className="h-4 w-4" />, keywords: ["settings", "account", "info"] },
  { title: "Settings", href: "/vendor/dashboard/settings", group: "Account", icon: <Settings className="h-4 w-4" />, keywords: ["preferences", "configuration"] },
